#!/usr/bin/env python3
"""
Step 3: Compare clusters across a grouping column
...
if __name__ == '__main__':
    # CLI usage:
    #   python 03_compare_clusters.py
    #   python 03_compare_clusters.py --group-by COLUMN
    #   python 03_compare_clusters.py --group-by COLUMN --groups v1 v2 v3
    ...
    try:
        ...
        print("\n" + report)
        print("\n" + "="*60)
        print("Step 3 Complete! Cluster comparison by group done.")
        print("="*60)
